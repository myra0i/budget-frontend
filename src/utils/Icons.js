...
export const calender = <i class="fa-regular fa-calendar"></i>
...
export const book = <i class="fa-solid fa-book-open-reader"></i>
export const food = <i class="fa-solid fa-bowl-rice"></i>
